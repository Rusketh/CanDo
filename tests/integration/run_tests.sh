...
run_smoke "test_crypto_ext" "$SCRIPTS/test_crypto_ext.cdo"
run_smoke "test_string_ext" "$SCRIPTS/test_string_ext.cdo"
run_smoke "test_datetime"     "$SCRIPTS/test_datetime.cdo"
run_smoke "test_datetime_ext" "$SCRIPTS/test_datetime_ext.cdo"
run_smoke "test_file_ext"   "$SCRIPTS/test_file_ext.cdo"
run_smoke "test_object_ext" "$SCRIPTS/test_object_ext.cdo"
run_smoke "test_math_ext"   "$SCRIPTS/test_math_ext.cdo"
